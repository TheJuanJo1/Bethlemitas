            ...
            <div class="container-div">
                <div class="form-group">
                    <div class="form-group-half">
                        ...
                        <select id="role" name="role" required>
                            ...
                            @foreach ($roles as $role)
                                <option value="{{ $role->id }}" @if ($user->roles->pluck('id')->contains($role->id)) selected
                                @endif>
                                    {{ $role->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="form-group-half">
                        ...
                        @error('name')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Incorrecto</span>
                            </p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group-half">
                        ...
                        @error('email')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">El email ya se
                                    encuentra registrado</span></p>
                        @enderror
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group-half" id="group_areas">
                        ...
                        @error('areas')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">¡Error! Campo
                                    vacío</span></p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group-half" id="group_group_director">
                        ...
                        @error('group_director')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">¡Error! El grupo ya
                                    cuenta con un director de grupo.</span></p>
                        @enderror
                    </div>
