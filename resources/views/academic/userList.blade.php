                    ...
                    <tr>  
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($user->groups->isNotEmpty())
                                {{ $user->groups->pluck('group')->implode(', ') }} <!-- Muestra los nombres de los grupos separados por comas -->
                            @else
                                "Sin Grupos"
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap"> {{ $user->director ? $user->director->group : '"Sin Grupo"' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if (is_array($userRoles[$user->id]))
