    ...
    <form action="{{ route('store.user') }}" method="POST" class="max-w-5xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 lg:p-8">
                ...
                <div class="space-y-5">
                    {{-- Áreas --}}
                    <div id="group_areas" style="display:none">
                    ...
                    {{-- Grupos --}}
                    <div id="group_load_group" style="display:none">
                    ...
                    {{-- Director de Grupo --}}
                    <div id="group_group_director" style="display:none">
                    ...
                    <div id="group_load_degree" style="display:none">
