...
@section('title','PIAR - Editar Periodo 3')
...
<div class="container-piar">
    ...
    <h2 style="margin-bottom: 25px; color: #0f172a; border-bottom: 3px solid var(--primary); display: inline-block; padding-bottom: 5px;">
        Editar PIAR - Ajustes Razonables (Periodo 3)
    </h2>

    <form action="{{ route('piar.update.periodo3') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div style="text-align:right; margin: 40px 0;">
            <button type="submit" class="btn-save">
                <i class="bi bi-cloud-check-fill"></i> GUARDAR TODOS LOS CAMBIOS - PERIODO 3
            </button>
        </div>
    </form>
</div>
