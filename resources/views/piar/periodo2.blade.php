...
<style>
    :root {
        ...
        --secondary: #0d9488; /* Color verde para distinguir el Anexo de Familia */
        --bg-light: #f1f5f9;
    ...
    <form action="{{ route('piar.periodo2.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="box-section" style="border-left: 8px solid var(--secondary);">
            ...
            <p style="font-size: 0.85rem; color: #64748b; margin-bottom: 15px;">
                Registre las actividades y estrategias que se trabajarán desde el hogar durante este segundo periodo.
            </p>
            ...
            <div class="table-responsive">
                <table id="tabla-anexo3">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input type="text" name="anexo3_actividad[]" class="form-control" placeholder="Nombre de la actividad">
                            </td>
                            <td>
                                <textarea name="anexo3_estrategia[]" class="form-control" style="height: 60px;" placeholder="¿Cómo lo hará la familia?"></textarea>
                            </td>
                            <td>
