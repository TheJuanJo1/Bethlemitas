...
Route::middleware([PreventBackHistoryMiddleware::class])->group(function () {
    Route::middleware(['auth'])->group(function () {
        ...
        |--------------------------------------------------------------------------
        */
        Route::get('/mi-perfil', [ProfileController::class, 'index'])->name('profile');
        ...
        */
        Route::middleware([RolePsicoorientadorMiddleware::class])->group(function () {
            ...
            Route::get('/psico/students/active', [PsicoController::class, 'index_students_active_psico'])->name('psico.students.active');
            Route::get('/psico/students/piar', [PsicoController::class, 'index_students_piar_psico'])->name('psico.students.piar');
            Route::get('/psico/students/dua', [PsicoController::class, 'index_students_dua_psico'])->name('psico.students.dua');
            ...
            Route::get('/psico/student/{id}/report', [PsicoController::class, 'current_report_student'])->name('psico.student.report');
            ...
            Route::post('/piar/ajustes/store', [PiarController::class, 'psicoGuardarAjustes'])->name('piar.psico.ajustes.store');
            Route::get('/psico/estudiante/historial-periodos/{id}', [PsicoController::class, 'show_piar_periods_history'])->name('piar.periodos.historial');
            Route::get('/psico/estudiante/pdf-periodo/{piar}/{adjustment}', [PsicoController::class, 'generate_period_pdf'])->name('piar.pdf.period');
            
            Route::get('/piar/{piar}/anexo3/{periodo}', [PiarController::class, 'showAnexo3'])->name('piar.anexo3');
            
            // Esta ruta es para guardar los compromisos que se escriban en el acta
            Route::post('/piar/anexo3/store', [PiarController::class, 'storeAnexo3'])->name('piar.anexo3.store');
            // ----------------------------------------------
        });
